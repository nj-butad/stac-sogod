        ...
        'administration' => [
            ...
            'sections' => [
                [
                    ...
                    'items' => [
                        'MOST REV. PRECIOSO D. CANTILLAS, S.DB., D.D - CHAIRMAN',
                        'REV. MSGR. OSCAR A. CADAYONA, P.C., Ph.D., SThL-MA - SECRETARY',
                        'REV. MSGR. MARNIE BANSIG, P.C. - MEMBER',
                        'REV. MSGR. NESTOR A. ASTILLO, P.C. - MEMBER',
                        'REV. FR. MERWIN L. KANGLEON, M.P.M. - MEMBER',
                    ],
                ],
                [
                    'label' => 'Google Site Section',
                    ...
                    'items' => [
                        'MOST REV. PRECIOSO D. CANTILLAS, S.DB., D.D - SCHOOL PRESIDENT',
                        'REV. FR. MERWIN L. KANGLEON, M.P.M. - SCHOOL DIRECTOR',
                        'RESSA A. PIGTE, LPT - ASST. SCHOOL DIRECTOR',
                        'ROLANDO F. AMPO, Ph.D. - OIC, COLLEGE DEAN',
                        'RESSA A. PIGTE, LPT - BASIC EDUCATION PRINCIPAL',
                        'RITO P. MANGYAO - TESDA COORDINATOR',
                    ],
                ],
                [
                    'label' => 'Google Site Section',
                    ...
                    'items' => [
                        ...
                        'RESSA A. PIGTE, LPT - BASIC EDUCATION PRINCIPAL',
                        'RITO P. MANGYAO - TESDA COORDINATOR',
                        'GENEROSA G. RUBIO, M.M. - HEAD, BUSINESS EDUCATION DEPARTMENT',
                        'AVELINO ALERIA, M.C.J.E. - HEAD, CRIMINAL JUSTICE EDUCATION DEPARTMENT',
                        'GENEVEVE C. FALCON, M.I.T. - HEAD, INFORMATION TECHNOLOGY EDUCATION DEPARTMENT',
                        'EDITA O. CANABE, MAEd - HEAD, TEACHER EDUCATION DEPARTMENT',
                        'MARICAR B. DE ONTOY, LPT - ASST. PRINCIPAL, ELEMENTARY DEPARTMENT',
                        'GLENDYL T. BUTRON, LPT - ASST. PRINCIPAL, JUNIOR HIGH SCHOOL',
                        'JOSEPHINE A. ACEBO, LPT - ASST. PRINCIPAL, SENIOR HIGH SCHOOL',
                    ],
                ],
                [
                    'label' => 'Google Site Section',
                    ...
                    'items' => [
                        'ALBERT P. FLORES, LPT - HEAD, SEED OFFICE',
                        'DAVE L. RELLANOS, LPT - COORDINATOR, THOMASIAN INTERNATIONAL AND LOCAL LINKAGES (TILL) OFFICE',
                        'JOHN CARLO J. RIMA, LPT - COORDINATOR, STRATEGIC OPPURTUNITIES FOR WORLD CLASS EDUCATION AND RESARCH (SOWER) OFFICE',
                        'JUPITH MARK R. TELIN - COORDINATOR, RECALIBRATING EDUCATION FOR ADVANCEMENT AND PROMOTION (REAP) OFFICE',
                    ],
                ],
            ],
            'children' => [],
