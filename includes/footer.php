                        ...
                        <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                            <div id="text-2" class="widget widget_text kingster-widget">
                                <div class="textwidget">
                                    ...
                                    <p><span id="span_983a_2">Phone: 0953 560 8222</span>
                                        <br /> <span class="gdlr-core-space-shortcode" id="span_983a_3"></span>
                                        <br /> <a id="a_983a_0" href="mailto:admin@stacsogod.edu.ph">Email: admin@stacsogod.edu.ph</a></p>
...
<?php if (!empty($extraScripts)) { echo "\n" . $extraScripts . "\n"; } ?>
</body>
